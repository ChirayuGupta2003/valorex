          ...
          body: SingleChildScrollView(
            child: Column(
              children: [
                ...
                Column(
                  children: character_info.map((e) => Character_Template(e))
                      .toList(),
                ),
                Padding(
                  padding: const EdgeInsets.fromLTRB(0, 15, 0, 0),
